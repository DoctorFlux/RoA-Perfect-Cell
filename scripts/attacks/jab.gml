...
set_window_value(AT_JAB, 4, AG_WINDOW_SFX, sfx_dbfz_swipe_weak2);
...
set_window_value(AT_JAB, 7, AG_WINDOW_SFX, sfx_dbfz_swipe_medium1);
...
set_window_value(AT_JAB, 9, AG_WINDOW_LENGTH, 20);
set_window_value(AT_JAB, 9, AG_WINDOW_ANIM_FRAMES, 4);
set_window_value(AT_JAB, 9, AG_WINDOW_ANIM_FRAME_START, 17);
set_window_value(AT_JAB, 9, AG_WINDOW_HAS_WHIFFLAG, 0); //yes it also applies to the last hit of the combo
...
set_hitbox_value(AT_JAB, 3, HG_WIDTH, 88);
...
set_hitbox_value(AT_JAB, 3, HG_HIT_SFX, sfx_dbfz_hit_medium);
set_hitbox_value(AT_JAB, 3, HG_HITBOX_GROUP, 3);
set_hitbox_value(AT_JAB, 3, HG_VISUAL_EFFECT_X_OFFSET, 16);
set_hitbox_value(AT_JAB, 3, HG_MUNO_HITBOX_NAME, "Hit 3");