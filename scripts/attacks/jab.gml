...
set_hitbox_value(AT_JAB, 2, HG_PROJECTILE_SPRITE, sprite_get("jab_proj"));
set_hitbox_value(AT_JAB, 2, HG_PROJECTILE_ANIM_SPEED, 1);
set_hitbox_value(AT_JAB, 2, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_JAB, 2, HG_HITBOX_X, 30);
set_hitbox_value(AT_JAB, 2, HG_HITBOX_Y, -56);
set_hitbox_value(AT_JAB, 2, HG_PROJECTILE_VSPEED, 15);
set_hitbox_value(AT_JAB, 2, HG_PROJECTILE_HSPEED, 20);
...
set_hitbox_value(AT_JAB, 3, HG_PROJECTILE_VSPEED, 15);
set_hitbox_value(AT_JAB, 3, HG_PROJECTILE_HSPEED, 20);
...
set_hitbox_value(AT_JAB, 3, HG_PROJECTILE_ENEMY_BEHAVIOR, 0);
