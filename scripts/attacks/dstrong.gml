...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, sfx_dbfz_swipe_heavy1);
...
set_hitbox_value(AT_DSTRONG, 1, HG_KNOCKBACK_SCALING, .8); // 0.7
...
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_SFX, sfx_dbfz_hit_medium);
...
set_hitbox_value(AT_DSTRONG, 2, HG_HIT_SFX, sfx_dbfz_hit_strong);
set_hitbox_value(AT_DSTRONG, 2, HG_ANGLE_FLIPPER, 6);
set_hitbox_value(AT_DSTRONG, 2, HG_HIT_LOCKOUT, 10);

set_hitbox_value(AT_DSTRONG, 3, HG_MUNO_HITBOX_NAME, "SSJ");
...
set_hitbox_value(AT_DSTRONG, 3, HG_HIT_SFX, sfx_dbfz_hit_broken);
