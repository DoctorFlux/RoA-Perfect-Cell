...
sprite_change_offset("vfx_nspecial_fire", 5100, 140);
sprite_change_offset("vfx_ftilt_destroy", 5100, 140); // actually for nspecial, not ftilt
sprite_change_offset("fspecial", 50, 77);
sprite_change_offset("fspecial_vfx", 50, 77);
...
sprite_change_offset("jab_proj", 24, 16);
...
sprite_change_offset("intro", 50, 70);
